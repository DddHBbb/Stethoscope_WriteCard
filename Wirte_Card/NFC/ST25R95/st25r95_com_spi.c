...
static uint8_t Idle[] = {ST25R95_COMMAND_IDLE, 0x0E, 0x02, 0x21, 0x00, 0x79, 0x01, 0x18, 0x00, 0x20, 0x60, 0x60, 0x64, 0x74, 0x3F, 0x08};
//static uint8_t Idle[] = {ST25R95_COMMAND_IDLE, 0x0E, 0x08, 0x01, 0x00, 0x38, 0x00, 0x18, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00};
/*
 ******************************************************************************
 * GLOBAL VARIABLES
 ******************************************************************************
...
// {GPIOB->MODER&=~(3<<(12*2));GPIOB->MODER|=1<<12*2;} 	//PB5Êä³öÄ£Ê½
...
//    {GPIOB->MODER&=~(3<<(12*2));GPIOB->MODER|=0<<12*2;}	//PB5ÊäÈëÄ£Ê½
